...
if __name__ == '__main__':
    source_url = 'https://nuage.lix.polytechnique.fr/index.php/s/oGb7FnSqC4DYEwT/download'
    target_dir = os.path.dirname(os.path.abspath(__file__))
    target_file = os.path.join(target_dir, 'intrinsic_interpolation_data.tar.gz')
